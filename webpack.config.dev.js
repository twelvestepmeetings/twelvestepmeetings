  ...
  */
  {
    ...
    resolve: {
      /**
      * Allows us to do stuff like `import thing from 'app/thing'`, which would import from
      * `/src/client/app/thing`
      */
  ...
  */
  {
    ...
    * source map. 'source-map' used to work, and it stopped working out of nowhere. I have no
    * idea why.
    */
